...
<div class="banner-card">
	<div class="post card banner-card-1 bg-white shadow-sm border-0 <?php if (get_option('argon_enable_into_article_animation') == 'true'){echo 'post-preview';} ?>">
		<div id="banner" class="banner section section-lg section-shaped">
